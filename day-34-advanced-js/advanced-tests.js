QUnit.test('When you create a transformer with a name, it has a name property on both Autobots and Decepticons', function( assert ) {
...
QUnit.test('Autobots need a property so we can know if they are transformed. Autobots are not transformed to start with, only become transformed with the transformed method is added. ', function(assert) {
...
QUnit.test('Decepticons need a property so we can know if they are transformed. Decepticons are not transformed to start with, only become transformed with the transformed method is added.', function(assert) {
...
QUnit.test('Autobots and Decepticons need way of storing a subtransformers property just in case they have them.', function(assert) {
