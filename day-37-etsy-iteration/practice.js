...
function mapItemTitles(array) {
  var itemTitles = array.map(mappedItems);

  function mappedItems(item) {
    return item.title;
  }
...
function madeBySellers(array) {
  var sellerMade = array.filter(filterSellerMade);

  function filterSellerMade(item) {
    return item.who_made === 'i_did';
  }
  return sellerMade.length;
}

var howManyMadeBySeller = madeBySellers(items);
console.log(howManyMadeBySeller);
